package com.cg.springcore7.assignment7;
...
public class Spel {
		...
		{  
			...
			Expression exp = parser.parseExpression("new String('sunil giri').toUpperCase()");  //Converting String contents into uppercase letter
